...
func (tx *Tx) init() {
	tx.OrganizationalUnit = NewOrganizationalUnitClient(tx.config)
	tx.OrganizationalUnitType = NewOrganizationalUnitTypeClient(tx.config)
...
// applies a query, for example: OrganizationalUnit.QueryXXX(), the query will be executed
